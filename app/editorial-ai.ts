...
function extractTitle(spread: string): string {
  const titles: Record<string, string> = {
    "Una carta": "Mensaje central",
    "Tres cartas": "La lectura",
    "Cruz Celta": "Lectura profunda",
    "Runas": "Consejo de las Runas",
    "I Ching": "La sabiduría del cambio",
  };

  for (const [key, title] of Object.entries(titles)) {
    if (spread.includes(key)) return title;
  }
