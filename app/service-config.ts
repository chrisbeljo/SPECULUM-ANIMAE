...
export const librarySystems = [
  ["Tarot","Disponible"],["Tarot Zen","Disponible"],["Ángeles","Disponible"],["Animales de Poder","Disponible"],
  ["Runas","Disponible"],["I Ching","Disponible"],["Radiestesia","Disponible"],["Chamalongos","Disponible"],
  ["Kabbalah","Disponible"],["Astrología","Próximamente"],["Numerología","Próximamente"],["Quiromancia","Próximamente"],
  ["Fisonomía","Próximamente"],["Energía / Aura","Próximamente"],["Feng Shui","Próximamente"],
  ["Horóscopo Chino","Próximamente"],["Cita con Madame Meraki","Próximamente"],
] as const;
