...
const copy: Record<Language, ChamalongosCopy> = {
  ES: {
    ...
    choose: "Elige el enfoque", count: "1 consulta", instruction: "Respira, mantén tu pregunta presente y toca las manos para realizar la caída.", result: "Configuración obtenida",
  ...
  EN: {
    ...
    choose: "Choose a focus", count: "1 consultation", instruction: "Breathe, keep your question present, and touch the hands to cast.", result: "Pattern obtained",
  ...
  FR: {
    ...
    choose: "Choisissez l’approche", count: "1 consultation", instruction: "Respirez, gardez votre question présente et touchez les mains pour lancer.", result: "Configuration obtenue",
  ...
  DE: {
    ...
    choose: "Schwerpunkt wählen", count: "1 Beratung", instruction: "Atmen Sie, behalten Sie Ihre Frage im Sinn und berühren Sie die Hände zum Werfen.", result: "Erhaltenes Muster",
  ...
  PT: {
    ...
    choose: "Escolha o enfoque", count: "1 consulta", instruction: "Respire, mantenha sua pergunta presente e toque as mãos para realizar a queda.", result: "Configuração obtida",
