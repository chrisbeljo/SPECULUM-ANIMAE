...
export function AstroConsultationFlow({ discipline, focus, focusIndex, lang, fromProfile=false,onOpenProfile }: { discipline: AstroDiscipline; focus: string; focusIndex: number; lang: Language; fromProfile?: boolean;onOpenProfile?:()=>void }) {
